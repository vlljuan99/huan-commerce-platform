...
urlpatterns = [
    ...
    path(
        "pedidos/<int:pk>/editar/", views.OrderUpdateView.as_view(), name="order_edit"
    ),
    # Customers
    ...
    path(
        "clientes/<int:pk>/", views.CustomerDetailView.as_view(), name="customer_detail"
    ),
    path(
    ...
    path(
        "clientes/<int:customer_pk>/direccion/nueva/",
    ...
    path(
        "facturas/<int:pk>/", views.InvoiceDetailView.as_view(), name="invoice_detail"
    ),
    path(
    ...
    # Catalog — variants
    path(
        "catalogo/<int:product_pk>/variante/nueva/",
        views.ProductVariantCreateView.as_view(),
        name="variant_create",
    ),
    path(
        "variantes/<int:pk>/editar/",
        views.ProductVariantUpdateView.as_view(),
        name="variant_edit",
    ),
    # Catalog — categories
    path(
        "catalogo/categorias/", views.CategoryListView.as_view(), name="category_list"
    ),
    path(
    ...
    path(
        "catalogo/categorias/<int:pk>/editar/",
    ...
    path(
        "catalogo/marcas/nueva/", views.BrandCreateView.as_view(), name="brand_create"
    ),
    path(
        "catalogo/marcas/<int:pk>/editar/",
    ...
    path(
        "catalogos-pdf/nuevo/",
        views.CatalogPDFCreateView.as_view(),
        name="catalogpdf_create",
    ),
    path(
        "catalogos-pdf/<int:pk>/editar/",
        views.CatalogPDFUpdateView.as_view(),
        name="catalogpdf_edit",
    ),
    path(
        "catalogos-pdf/<int:pk>/eliminar/",
        views.CatalogPDFDeleteView.as_view(),
        name="catalogpdf_delete",
    ),
    # Services
    ...
    path(
        "servicios/categorias/<int:pk>/editar/",
    ...
    path(
        "visualiza-tu-obra/", views.VisualizaObraView.as_view(), name="visualiza_obra"
    ),
    path(
        "visualiza-tu-obra/productos/",
        views.ProductImagePickerView.as_view(),
