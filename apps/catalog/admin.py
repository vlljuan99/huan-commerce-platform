...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('name', 'slug', 'category', 'brand', 'sku_base', 'is_featured', 'is_active')
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'slug', 'description', 'category', 'brand', 'sku_base', 'is_active'),
        }),
        ('Detalles', {
...
class ProductVariantAdmin(admin.ModelAdmin):
    list_display = ('sku', 'product', 'name', 'price_no_tax', 'stock_quantity', 'is_active')
