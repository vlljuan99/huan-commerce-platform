...
class ProductBrand(BaseModel):
    ...
    logo = models.ImageField(
        upload_to="brands/", null=True, blank=True, verbose_name=_("Logo")
    )
...
class Product(BaseModel):
    ...
    seo_title = models.CharField(
        max_length=255, blank=True, verbose_name=_("SEO title")
    )
...
class ProductVariant(BaseModel):
    ...
    name = models.CharField(
        max_length=255, verbose_name=_("Variant name (e.g., Red, Large)")
    )
    ...
    image = models.ImageField(
        upload_to="products/", null=True, blank=True, verbose_name=_("Primary image")
    )
