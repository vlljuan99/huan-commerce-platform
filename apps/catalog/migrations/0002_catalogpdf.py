    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf_file', models.FileField(upload_to='catalogs/pdf/', verbose_name='PDF file')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='catalogs/covers/', verbose_name='Cover image')),
