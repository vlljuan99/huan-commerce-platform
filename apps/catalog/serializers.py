...
class ProductVariantSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'sku', 'name', 'price_no_tax', 'stock_quantity', 'image', 'is_in_stock']
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'name', 'slug', 'category', 'brand', 'sku_base', 'is_featured', 'primary_variant']
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'brand', 'sku_base', 'unit_of_measure',
            'weight', 'is_featured', 'seo_title', 'seo_description',
